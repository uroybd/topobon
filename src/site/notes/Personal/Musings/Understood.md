...
> [!INFO] Understand (Verb)
> 1. to know the meaning of something
> 2. to know why or how something happens or works
> 3. to know how someone feels or why someone behaves in a particular way
> 
> ###### Etymology
> Composed of _under_ (meaning between/among, similar to Latin _inter_) + _standan_ (to stand).
...
One of those very common words is _understand_. We use this word every day, in a myriad of situations with diverse contexts, as you can see in the definition of the word I presented.[^1]

To understand our usage of the word 'understand', let's look into the synonyms:

> [!INFO] Comprehend
> "To seize together" (_com-_ together + _prehendere_ to seize).
...
> [!INFO] Discern
> From Latin _discernere_ (_dis-_ apart + _cernere_ to separate). It literally means to **sift** or separate the truth from the noise.
...
[^1]: The [actual list](https://dictionary.cambridge.org/dictionary/english/understand) It is much longer.